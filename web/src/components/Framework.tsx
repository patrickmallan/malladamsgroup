...
const LAYERS = [
  ...
  },
  {
    ...
    body:
      'A beautiful building with a broken internal culture is still a broken structure. We design the invisible architecture too — how people are hired, how leadership is practiced, how daily life flows. This is the layer that sustains the life force of everyone inside.',
  },
] as const
